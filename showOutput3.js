...
document.getElementById('submit').addEventListener(
    ...
    function() {
        ...
        ***************/
        ...
        layoutMacroOutputPreamble = layoutMacroOutput.length;
        ...
        *******************************/
        ...
        for ( i = matrix_rows-1; i >= 0; i-- ) {
            ...
            layoutMacroOutput.splice((layoutMacroOutputPreamble - 1), 0, "    { "+ matrix[i].join(', ').replace(/( +),/g, ",$1") +" }, \\" );
        }
        // inserts Physical Switch Matrix at index 23
        layoutMacroOutput.splice((layoutMacroOutputPreamble - 2 ), 0, layoutMacro);
